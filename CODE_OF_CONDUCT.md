...
> **Maintainers:** replace `<CONTACT>` below with the address conduct reports should reach
> before merging. `security@crowdsec.net` is for vulnerability disclosure and is not a
> substitute.
...
community leaders responsible for enforcement at `<CONTACT>`. All complaints will be reviewed
